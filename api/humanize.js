...
export default async function handler(req, res) {
  ...
  try {
    // Using OpenRouter to call Z.ai's GLM 5.2 model.
    // Free tier slug below (~50 req/day cap per OpenRouter's free-tier limits).
    // Swap to "z-ai/glm-5.2" (no :free) for paid/higher-uptime routing if you
    // outgrow the free tier's rate limit.
